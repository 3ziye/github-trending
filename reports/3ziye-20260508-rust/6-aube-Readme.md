...
<!-- BENCH_RATIOS:START -->
**[Fast installs](https://aube.en.dev/benchmarks).** Warm installs are about 7x faster than pnpm and about 7x faster than Bun in the current benchmarks. Repeat test commands run up to 26x faster than pnpm and up to 6x faster than Bun.
<!-- BENCH_RATIOS:END -->
