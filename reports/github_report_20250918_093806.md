...
| 项目信息 | 详情 |
|---------|------|
| **项目名称** | [OtterHacker/AWSDoor](https://github.com/OtterHacker/AWSDoor) |
| **项目描述** | AWSDoor is a red team automation tool designed to simulate advanced attacker behavior in AWS environ... |
| **主要语言** | Python |
| **许可证** | None |
| **⭐ 星标数** | 14 |
| **🍴 Fork 数** | 1 |
...
**📂 克隆地址**: `https://github.com/OtterHacker/AWSDoor.git`
