...
Local recognition downloads models on first use. GPU / CPU recognition also needs `llama-server`; cloud recognition requires your own API configuration. The app provides setup controls; see the [first-launch guide](https://github.com/mizorewww/course2md/wiki/GUI-Installation#first-launch) fo